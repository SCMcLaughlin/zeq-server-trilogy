...
uint8_t mob_material_id(void* mob, int n);
void mob_update_material_id(void* mob, int n, uint8_t matId);
uint32_t mob_tint(void* mob, int n);
void mob_update_tint(void* mob, int n, uint32_t color);
